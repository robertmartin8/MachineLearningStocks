...
def backtest():
    ...
    # The labels are generated by applying the status_calc to the dataframe. If a stock outperforms
    # the S&P500 by more than 10%, it is considered a '1'. Otherwise, it is a '0'.
    y = list(
